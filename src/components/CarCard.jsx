...
const CarCard = ({ car, showModal, setModal, setCar }) => {
    return (
        <div className="flex flex-col md:flex-row md:max-w-xl overflow-hidden rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 relative"
            >
