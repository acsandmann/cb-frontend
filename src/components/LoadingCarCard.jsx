...
const LoadingCarCard = () => {
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="flex flex-col md:flex-row md:max-w-xl overflow-hidden rounded-lg bg-gray-800 relative"
        >
            <div className="flex flex-col justify-between p-4 leading-normal flex-grow z-10">
                ...
                <div className="animate-pulse h-10 bg-blue-800 opacity-50 rounded w-32"></div> 
            </div>
